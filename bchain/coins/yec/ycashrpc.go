...
// NewYCashRPC returns new YCashRPC instance
...
// Initialize initializes YCashRPC instance
...
func (z *YCashRPC) GetChainInfo() (*bchain.ChainInfo, error) {
...
func (z *YCashRPC) GetBlockRaw(hash string) (string, error) {
