...
// NewYCashParser returns new YCashParser instance
...
// the regression test YCash network, the test YCash network and
// the simulation test YCash network, in this order
